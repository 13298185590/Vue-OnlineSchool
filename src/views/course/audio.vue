<template>
  <div class="app-container">
    <el-button type="primary" icon="el-icon-edit" @click="handleCreate">新增音频</el-button>
...
import { fetchList, updateAudio, deleteAudio,createAudio } from "@/api/audio";
...
export default {
  ...
  methods: {
    ...
    handleModifyStatus(row, status) {
      updateAudio(row.status).then((response) => {
